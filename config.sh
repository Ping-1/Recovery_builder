...
export BRANCH="aosp -b twrp-12.1" # the branch of manifest

# about your device
export DEVICE="a04" # codename used in device tree
export DT_LINK="https://github.com/Ping-1/android_device_samsung_a04" # device tree link
